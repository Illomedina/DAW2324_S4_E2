        ...
        <div className="lg:pl-56">
          ...
          <main className="bg-gray-100 py-5 h-screen overflow-y-auto">
            <div className="px-4 sm:px-6 lg:px-8">
              {window.location.href.includes("benefits") == false || window.location.href.includes("Benefits") == false || window.location.href.includes("Dashboard") == false || window.location.href.includes("dashboard") && (
